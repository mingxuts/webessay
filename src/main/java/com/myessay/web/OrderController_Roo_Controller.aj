...
import com.myessay.web.OrderController;
...
privileged aspect OrderController_Roo_Controller {
    ...
    public String OrderController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String OrderController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, orderRepository.findOne(id));
        return "orders/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String OrderController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void OrderController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("order_createdate_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
