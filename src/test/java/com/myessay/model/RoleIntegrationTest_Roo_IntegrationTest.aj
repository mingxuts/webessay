...
import com.myessay.model.RoleIntegrationTest;
...
privileged aspect RoleIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void RoleIntegrationTest.testCount() {
    ...
    @Test
    public void RoleIntegrationTest.testFind() {
    ...
    @Test
    public void RoleIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", dod.getRandomRole());
        long count = roleRepository.count();
    ...
    @Test
    public void RoleIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", dod.getRandomRole());
        long count = roleRepository.count();
        if (count > 20) count = 20;
        int firstResult = 0;
        int maxResults = (int) count;
        List<Role> result = roleRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    @Test
    public void RoleIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", dod.getRandomRole());
    ...
    @Test
    public void RoleIntegrationTest.testDelete() {
        Role obj = dod.getRandomRole();
        Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", obj);
        Integer id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Role' failed to provide an identifier", id);
        ...
        roleRepository.flush();
        Assert.assertNull("Failed to remove 'Role' with identifier '" + id + "'", roleRepository.findOne(id));
    }
